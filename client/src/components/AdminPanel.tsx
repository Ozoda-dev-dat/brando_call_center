  ...
  return (
    <div className="flex-1 bg-gray-50 dark:bg-gray-900 overflow-auto">
      <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Sozlamalar</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Tizim sozlamalari</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 min-h-[60vh]">
        <Card className="p-12 text-center max-w-md">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Sozlamalar bo'limi hozirda ishlab chiqilmoqda. Tez orada yangi imkoniyatlar qo'shiladi.
          </p>
        </Card>
      </div>
    </div>
